...
func PlayerMigrate(pctx context.Context, cfg *config.Config) {
	...
	log.Printf("Migrate auth completed: ", results)
	...
	log.Println("Migrate player_transactions complated: ", results)
	...
	log.Println("Migrate player_transactions_queue complated: ", result)
}
